...
```
cd existing_repo
git remote add origin https://gitlab.bubo-tennis.com/izysearch/websites/kumbu-landing-page.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bubo-tennis.com/izysearch/websites/kumbu-landing-page/-/settings/integrations)
